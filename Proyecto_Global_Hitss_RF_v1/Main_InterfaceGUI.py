...
class ingresar_ventana(wx.Frame): 
    ...
    def __init__(self, parent, title): 
        ...
        self.lbldni = wx.StaticText(self.panel, label="Ingrese nombre de colaborador:")         
    ...
    def OnButton(self, e):
        ...
        dest="ClasificadorKNN/train/"+self.editname.GetValue()+" "+self.editDNI.GetValue()
        try:
            os.mkdir(dest)
        except:
    ...
    def OnButton2(self,e):
        ...
        try:
            ...
            print("LA CARPETA YA EXISTE")
            pass
        tomador_fotos_cerca(video_capture,self.editname.GetValue()+" "+self.editDNI.GetValue())
        cv2.destroyAllWindows()
    def OnButton3(self,e):
        try:
            ...
            print("LA CARPETA YA EXISTE")
            pass
        tomador_fotos_lejos(video_capture,self.editname.GetValue()+" "+self.editDNI.GetValue())  
        cv2.destroyAllWindows()
...
class eliminar_ventana(wx.Frame): 
    ...
    def OnButton(self, e): 
        dest="ClasificadorKNN/train/"+self.editname.GetValue()
        shutil.rmtree(dest)
        ...
        #self.result.SetLabel(self.editname.GetValue()) 
        try :
            hilo=threading.Thread(target=eliminar_ususario)
            hilo.start()
        except:
...
class configurar_ventana(wx.Frame): 
    ...
    def __init__(self, parent, title): 
        ...
        self.editname = wx.TextCtrl(self.panel, size=(100, -1)) 
                                ...
                                if predictions:
                                    ...
                                    if faceID != -1:
                                        ...
                                        if Known_face_bandera[faceID] == 0:
                                            ...
                                            for caracter in str(predictions[index][0]):
                                                if caracter==" ":
                                                    k+=1
                                                if k==1:
                                                    print(caracter)
